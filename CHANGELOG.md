...
## Pre-Release 0.1.1 [Unreleased / v0.0.1.1]

This release is based off of [Mastodon 2.9.2].

[Mastodon 2.9.2]: https://github.com/tootsuite/mastodon/blob/v2.9.2/CHANGELOG.md

(TODO: Florence-specific additions.)
